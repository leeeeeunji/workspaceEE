...
public class HttpServletResponseServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
		http://192.168.15.10/servletSite/response.do?cmd=1
		http://192.168.15.10/servletSite/response.do?cmd=2
		http://192.168.15.10/servletSite/response.do?cmd=3
		http://192.168.15.10/servletSite/response.do?cmd=
		http://192.168.15.10/servletSite/response.do
		 */
		...
		if(cmd.equals("1")) {
			...
			response.sendError(HttpServletResponse.SC_METHOD_NOT_ALLOWED); //405번
