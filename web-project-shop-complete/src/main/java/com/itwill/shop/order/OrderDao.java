...
public class OrderDao {
	...
	public Order findByOrderNo(int o_no) throws Exception {
		 ...
		 * O_NO 	O_DESC 	O_DATE 		O_PRICE USERID OI_NO OI_QTY O_NO P_NO P_NAME 	P_PRICE P_IMAGE P_DESC 
		 * ---------------------------------------------------------------------------------------------------------------------
		 * 2 	비글외1마리 2023/01/06 1550000 	guard1 	1 		1 	1 		1 비글 		550000 bigle.png 기타 상세 정보 등... 0 
		 * 2 	비글외1마리 2023/01/06 1550000 	guard1 	2 		2	1 		2 달마시안 	500000 dalma.jpg 기타 상세 정보 등... 0
		 * 2 	비글외1마리 2023/01/06 1550000 	guard1 	2 		2 	1 		2 달마시안 	500000 dalma.jpg 기타 상세 정보 등... 0
		 */
		if (rs.next()) {
